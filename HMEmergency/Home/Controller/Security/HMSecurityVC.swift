...
class HMSecurityVC: UIViewController {
    ...
    @objc func sentBtnDidTouch() {
        ...
        socketSentMessage(message: bottomTextView.textView.textView.text!)
    }
...
extension HMSecurityVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    // datasource
...
extension HMSecurityVC: WebSocketDelegate {
