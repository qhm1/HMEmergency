...
class HMHandBookDetalVC2: UIViewController {
    var id:Int64!
        ...
        AF.request(path,
            ...
            case let .success(value):
                if let JSON = value as? [String: Any] {
                    ...
                    for item in list {
                        let temp1: String = item["name"] as! String
                        let temp2: String = item["description"] as! String
                        let nameString: String =  temp1+temp2
                        let model = titlesModel(name: nameString, id: item["id"] as! Int64)
...
extension HMHandBookDetalVC2: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
