 ...
 * 最常见的用法是把自定义的时间戳（timstamp）用本接口嵌入视频帧中，实现消息和画面的完美对齐（比如：教育场景下的课件和视频信号的对齐）。
...
- (void)startMicDeviceTest:(NSInteger)interval 
                  ...
                  __attribute__((deprecated("use TXDeviceManager#startMicDeviceTest instead")));
#endif
...
- (void)startSpeakerDeviceTest:(NSString*)audioFilePath 
               ...
               __attribute__((deprecated("use TXDeviceManager#startSpeakerDeviceTest instead")));
#endif
...
- (void)snapshotVideo:(NSString *)userId
                 type:(TRTCVideoStreamType)streamType
      completionBlock:(void (^)(TXImage *image))completionBlock 
      __attribute__((deprecated("use snapshotVideo:type:sourceType:completionBlock instead")));
 ...
 * 开始应用内的屏幕分享（iOS）
 * 
 * @deprecated v8.6 版本开始不推荐使用，建议使用 startScreenCaptureInApp(streamType,encParams) 接口替代之。
 */
 ...
 * 开始全系统的屏幕分享（iOS）
 * 
 * @deprecated v8.6 版本开始不推荐使用，建议使用 startScreenCaptureByReplaykit(streamType,encParams) 接口替代之。
 */
